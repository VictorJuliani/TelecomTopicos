...
public abstract class AbstractSimulation
{
	...
	public void run()
	{
		Customer jim = new Customer("Jim", 650, "3361-1112");
		Customer mik = new Customer("Mik", 650, "3361-1113");
		Customer crista = new Customer("Crista", 415, "3361-1114");
